...
package com.ayse.fridgeapp.tracking;
...
import com.ayse.fridgeapp.tflite.Classifier.Recognition;
...
public class MultiBoxTracker {
    ...
    public synchronized void draw(final Canvas canvas, final boolean isDebug) {
