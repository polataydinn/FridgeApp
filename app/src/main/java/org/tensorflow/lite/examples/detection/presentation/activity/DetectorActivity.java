...
package org.tensorflow.lite.examples.detection.presentation.activity;
...
import org.tensorflow.lite.examples.detection.presentation.activity.BaseActivity;
import org.tensorflow.lite.examples.detection.presentation.activity.CameraActivity;
...
public class DetectorActivity extends CameraActivity implements OnImageAvailableListener {
    ...
    private static final String TF_OD_API_MODEL_FILE = "food_detect.tflite";
    private static final String TF_OD_API_LABELS_FILE = "file:///android_asset/food_labelmap.txt";
                            ...
                            public void onClick(View v) {
                                for (final Classifier.Recognition result : results) {
                                    ...
                                    if (location != null && result.getConfidence() >= finalMinimumConfidence) {
                                        ...
                                        result.setLocation(location);
                                        mappedRecognitions.add(result);
                                        BaseActivity.getInstance().addFood(String.format(result.getTitle()));
                                    }
                                }
                                finish();
                            }
